...
export const MaliMessage = () => {
  return (
    <div className="hidden xl:block absolute top-16 right-[13.5rem] max-w-[17.5rem] py-6 px-8 bg-black rounded-t-xl rounded-tr-xl rounded-br-xl font-code text-base">
      Bark!
