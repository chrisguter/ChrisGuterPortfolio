...
export const de: Content = {
  ...
  hero: {
    ...
    thesis:
      "Seit über zehn Jahren baue ich Software, vom Engineer bis zum Scrum Master. Ich bleibe nah an der Technik und schreibe selbst Code — was mich aber vor allem antreibt: Teams auf ein gemeinsames Ziel auszurichten, Blocker aus dem Weg zu räumen und dafür zu sorgen, dass wir die richtigen Dinge richtig bauen.",
    roles: [
    ...
    projects: [
      {
        ...
        study: {
          ...
          outcome:
            "Der erste spielbare Prototyp stand nach wenigen Tagen; der Feinschliff hat deutlich länger gedauert. KI-Vorschläge für Physik-Werte klangen plausibel und fühlten sich im Spiel falsch an — Fallgeschwindigkeit und Mergeverhalten habe ich in vielen Testrunden von Hand nachjustiert. Seit Januar 2026 ist das Spiel in beiden Stores live — und ich weiß aus erster Hand, wo diese Werkzeuge tragen und wo sie aufhören.",
        },
        links: [
          {
            label: "App Store",
      ...
      },
      {
        ...
        study: {
          ...
          decision:
            "Ich verantworte dieses Projekt komplett, inklusive Budget, und bin der direkte Draht zum Kunden: Wenn Bioland eine technische Frage hat, landet sie in keiner Ticket-Warteschlange — dann klingelt mein Telefon. Das heißt auch: Änderungen werden gemeinsam mit dem Kunden zugeschnitten, bevor sie zur Spezifikation werden.",
          outcome:
      ...
      },
      {
        ...
        study: {
          ...
          decision:
            "Den zweiten Faktor habe ich als plattformübergreifende Mobile-App gebaut, die zeitbasierte Einmalcodes ausgibt, und in den bestehenden Login eingebunden. Der Rollout hat genauso viel Sorgfalt bekommen wie der Code — wenn der zweite Faktor nervt, wird er umgangen.",
          outcome:
  ...
  skills: {
    ...
    nodes: [
      ...
      },
      {
        ...
        group: "ai",
        related: ["flutter"],
        note: "Der komplette Dropigon-Soundtrack kommt aus Suno. Musik ist eine Rolle, die ein Solo-Entwickler schlicht nicht besetzen kann — KI hat sie gefüllt.",
      },
      ...
      { id: "vaadin", label: "Vaadin", group: "engineering", related: ["sql"] },
      {
        ...
        note: "Configure-Price-Quote: Regelwerke, bei denen die falsche Antwort echtes Geld kostet. SAMPlus von Daimler Truck.",
      },
      {
        id: "einvoicing",
        label: "E-Rechnung",
        group: "engineering",
        related: ["cpq"],
        note: "Strukturierte, rechtskonforme Rechnungsformate — ein Feld, in dem „fast richtig“ heißt: abgelehnt.",
      },
  ...
  now: {
    ...
    intro:
      "Zwei Projekte am Abend — eines mit dem Studio, eines allein. Beide unfertig, beide in Bewegung.",
    readMore: "Mehr dazu",
    close: "Schließen",
    items: [
      {
        ...
        study: {
          sections: [
            ...
            },
            {
              ...
              body: [
                "Die Entwicklungs-Variante läuft komplett ohne Firebase — Mock-Anmeldung, lokale Daten, kein Cloud-Setup —, eine Abendsession startet also in Sekunden. Echte Screenshots folgen, sobald die App nach etwas aussieht; bis dahin ist die Architektur das ehrliche Bild.",
              ],
            },
          ],
          architecture: {
      ...
      },
      {
        ...
        detail:
          "Die KI erklärt, sie entscheidet nie. Nur die Execution-Schicht darf mit dem Broker reden — ein Prüfwerkzeug lässt den Build fehlschlagen, wenn es etwas anderes versucht — und jede Position bekommt eine Verkaufsgrenze direkt beim Broker, damit sie auch greift, wenn der Bot abstürzt. Backtests spielen zehn Jahre Kursdaten in etwa einer Minute durch. Noch Paper-Trading: simuliertes Geld, bis die Zahlen echtes verdienen.",
          ...
          sections: [
            {
              ...
              body: [
                "Ich wollte wissen, ob ein Bot Aktien eigenständig analysieren und auf dieser Basis handeln kann — mit Entscheidungen, die ich nachlesen kann. KI-Modelle fassen dafür Nachrichten und Kennzahlen zusammen und erklären ihre Einschätzung in natürlicher Sprache; die Kauf- oder Verkaufsentscheidung selbst trifft ein fester, nachvollziehbarer Algorithmus aus Kurssignalen, Kennzahlen und Nachrichtenstimmung.",
              ],
            },
            {
            ...
            },
            {
              ...
              body: [
                ...
                "Würde ich neu anfangen, würde ich zuerst die Möglichkeit bauen, ein Ergebnis gegen etwas Echtes zu prüfen — und erst danach das Feature selbst. Und wo Geld im Spiel ist, bleibt die Regel: KI erklärt, sie entscheidet nie.",
              ],
            },
          ],
          gallery: [
  ...
  timeline: {
    label: "Werdegang",
    heading: "Vom Software Engineer zum Scrum Master — und weiter am Code.",
    ...
    entries: [
      ...
      },
      {
        ...
        details: [
          ...
          "Erstellung und Pflege von Projekt-Roadmaps, die die Entwicklungsarbeit mit den Geschäftszielen verbinden; regelmäßige Vorstellung vor der Bereichsleitung, damit Richtung und Stand transparent bleiben.",
      ...
      },
      {
        ...
        details: [
          ...
          "Implementierung eines neuen Frameworks zur UI-Testautomatisierung als Ersatz für ein teures Lizenztool — Einsparung von mehreren Tausend Euro pro Jahr; die Lösung ist bis heute produktiv im Einsatz.",
    ...
    items: [
      {
        ...
        body: "Diesen Unterschied herauszuarbeiten ist die eigentliche Ingenieursarbeit. Eine Anforderung kommt bereits als fertige Lösung formuliert, und genau das zu bauen ist der bequeme Weg — das eigentliche Problem bleibt dabei einfach liegen. Also bleibe ich so lange im Gespräch, bis der Bedarf dahinter klar ist. Wenn Bioland oder Daimler Truck eine technische Frage hat, landet sie direkt bei mir, und es ist selten die erste Antwort, die sich am Ende wirklich zu bauen lohnt.",
      },
      {
        id: "blockers",
        title:
          "Ein Standup, in dem Status berichtet wird, ist ein Termin, kein Werkzeug",
        body: "Ein Standup ist für den Tag da, der vor uns liegt: Jeder kennt seinen Plan, der Plan ist wirklich machbar, und was ihm im Weg steht — eine offene Frage, ein Impediment — wird vorab ausgeräumt. Wer nur den Status von gestern berichtet, lässt genau dieses Ziel fallen. Und beim Vertrauen gilt dasselbe in die andere Richtung: „Ich hänge seit Montag fest“ sollte nie auf ein Standup warten müssen. Das will ich am Montag hören — das Standup ist dafür da, dass der Tag funktioniert, nicht dafür, dass Probleme endlich ans Licht kommen.",
      },
      {
        id: "ai",
        title: "Wo KI aufhört zu helfen, merkt man erst, wenn man damit ausliefert",
        body: "Die Grenzen dieser Werkzeuge habe ich nicht von Folien gelernt. Ich habe ein Spiel damit gebaut und veröffentlicht — Code, Grafik, sogar die Musik — und dabei aus erster Hand gesehen, was unter echtem Termindruck trägt und was ein verlorener Abend ist. Die eigentlich spannende Arbeit besteht inzwischen darin, Anforderungen so scharf zu formulieren, dass ein Agent wirklich damit arbeiten kann.",
      },
      {
        id: "coordination",
        title: "Die meisten technischen Probleme sind Abstimmungsprobleme",
        body: "Das ist die Linie durch die letzten zehn Jahre und der Grund, warum ich vom Schreiben von Software dazu gewechselt bin, dafür verantwortlich zu sein, wie sie geschrieben wird. Wenn ein Projekt stockt, liegt es selten daran, dass niemand das technische Problem lösen konnte. Es liegt daran, dass zwei Leute jeweils die Hälfte gelöst haben, dass eine Woche auf eine Antwort gewartet wurde, von der niemand wusste, dass er sie schuldet, oder dass alle von Annahmen ausgingen, die nie jemand ausgesprochen hat. Bringt man die Abstimmung in Ordnung, entstehen erstaunlich viele technische Probleme gar nicht erst.",
      },
    ],
  },
